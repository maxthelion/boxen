...
This moves all tasks from provisional -> done, bypassing the validator.
"""
...
from orchestrator.orchestrator.queue_utils import list_tasks, accept_completion
...
def main():
    ...
    for task in tasks:
        ...
        commits = task.get("commits_count", "?")
