...
export class DividerPanelNode extends BasePanel {
  ...
  computeHoles(): PanelHole[] {
    // Note: Divider-to-divider intersections use cross-lap slots (edge notches),
    // not interior holes. This method returns empty unless sub-assembly slots
    // or other special cases are implemented in the future.
    return [];
  }
