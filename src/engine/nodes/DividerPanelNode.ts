...
export class DividerPanelNode extends BasePanel {
  ...
  computeHoles(): PanelHole[] {
    // Note: Divider-to-divider intersections are handled by cross-lap slots (edge notches),
    // not interior holes. Sub-assembly slots or other special cases could be added here in the future.
    return [];
  }
